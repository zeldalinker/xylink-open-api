...
!function() {
	...
	function _createQueueReadyIframe(doc) {
		//if(doc.getElement('iframe') != null && doc.getElement('iframe') != undefined){
		if(!messagingIframe){
...
function takeVideo(param) {
	formateJsonAndCallHander("takeVideo", param);
}

function playVideo(param) {
	formateJsonAndCallHander("playVideo", param);
}
...
function getDeviceInfo(param) {
	formateJsonAndCallHander("getDeviceInfo", param);
}
