...
import com.xylink.admin.handler.MyBatisMetaObjectHandler;
...
public class MySqlDataSourceConfiguration {
	...
	public DruidDataSource dataSource(@Value("${mysql.jdbc.driverClassName}") String driverClassName,
									  @Value("${mysql.jdbc.url}") String url,
									  @Value("${mysql.jdbc.username}") String username,
									  @Value("${mysql.jdbc.password}") String password) throws SQLException {
